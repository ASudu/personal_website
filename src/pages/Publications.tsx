    ...
    <Layout title="Publications | Sudarshan Anand" activePage="publications">
      <div id="publications-content">
        ...
        <div className="publications-section">
          <h2 style={{ marginTop: '0' }}>Journal Papers</h2>
            ...
            <div className="project-item">
              <div className="education-details" style={{ flex: 1 }}>
                <h4 style={{ fontSize: '1.3rem', marginBottom: '0.5rem' }}>
                  On Burden of Diseases, Prevention, Medical Research and Health Service Delivery: Grampian Case Study <p className='project-duration'>[June 2026]</p>
                </h4>
                <p style={{ fontSize: '1.1rem', color: 'var(--theme-text-secondary)' }}>
                  <em>International Journal of Environmental Research and Public Health, MDPI, June 2026</em>
                </p>
                <p style={{ fontSize: '1.1rem', color: 'var(--theme-text-secondary)' }}>
                  <strong>Authors:</strong> Seshadri S. Vasan, <strong>Sudarshan Anand</strong>, Miae Lee, and Nicholas C. Fluck
                </p>
                <p style={{ fontSize: '1.2rem' }}>
                  [<a
                    className='blog-link'
                    href="https://www.mdpi.com/1660-4601/23/6/763"
                    target="_blank"
